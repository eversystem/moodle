...
/**
 * Strings for component 'repository_nextcloud', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['chooseissuer'] = '発行者';
$string['chooseissuer_help'] = '新しい発行者を追加するには「サイト管理 / サーバ / OAuth 2サービス」にアクセスしてください。';
...
$string['fileoptions'] = 'ここで戻りファイルのタイプおよびデフォルトを設定することができます。外部にリンクされたすべてのファイルはMoodleシステムアカウントがオーナーになるよう更新されることに留意してください。';
...
$string['issuervalidation_invalid'] = '現在、{$a} 発行者は有効ですが、必要なすべてのエンドポイントを実装しているわけではありません。リポジトリは動作しません。';
$string['issuervalidation_valid'] = '現在、{$a} 発行者は有効です。';
$string['issuervalidation_without'] = 'あなたはまだOAuth 2発行者としてのNextcloudサーバを選択していません。';
$string['nextcloud'] = 'Nextcloud';
$string['nextcloud:view'] = 'Nextcloudを表示する';
$string['noclientconnection'] = 'OAuthクライアントに接続できません。';
$string['no_right_issuers'] = '必要なエンドポイントを実装している既存の発行者はありません。適切な発行者を登録してください。';
...
$string['right_issuers'] = '次の発行者は必要なエンドポイントを実装します: <br /> {$a}';
