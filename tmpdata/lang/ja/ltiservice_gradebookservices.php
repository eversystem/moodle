...
/**
 * Strings for component 'ltiservice_gradebookservices', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
* **このサービスを評定同期のみに使用する** - サービスは既存の評定表カラムに評点を追加しますが、新しいカラムを作成することはできません。
...
$string['partialgs'] = 'このサービスを評定同期のみに使用する';
