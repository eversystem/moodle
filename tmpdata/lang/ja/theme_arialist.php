...
/**
 * Strings for component 'theme_arialist', language 'ja', branch 'MOODLE_32_STABLE'
 *
...
$string['regionwidth'] = 'カラム幅';
$string['regionwidthdesc'] = 'ここでは左右のカラムを形成するブロックの幅を設定します。';
$string['tagline'] = 'タグライン';
$string['taglinedesc'] = 'フロントページのサイト名下部に短いタグラインが表示されます。<br />(ロゴは表示されません)';
