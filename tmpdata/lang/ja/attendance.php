...
/**
 * Strings for component 'attendance', language 'ja', branch 'MOODLE_38_STABLE'
 *
 * @package   attendance
...
$string['studentavailability_help'] = '学生が自分の出欠を取る場合、セッション開始後の指定した時間 (分) でこのステータスが利用可能となります。
