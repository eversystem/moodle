...
/**
 * Strings for component 'block_mrbs', language 'ja', branch 'MOODLE_31_STABLE'
 *
 * @package   block_mrbs
...
$string['config_new_window'] = 'ウインドウ';
$string['config_new_window2'] = '「新しいウインドウ」を選ぶと、MRBSブロック用に新しいウインドウが開きます。「同じウインドウ」を選ぶとMoodleのウインドウ内にMoodleヘッダーつきで開きます。';
