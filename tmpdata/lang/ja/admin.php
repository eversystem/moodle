...
$string['task_adhoc_max_runtime'] = 'アドホックランナー生存期間';
$string['task_adhoc_max_runtime_desc'] = 'スケジュールタスクが取り除かれるまでの時間です。キューに入れられるアドホックタスク数の制限がなくなるため低い継続期間を推奨します。この数が高すぎる場合、そして多くのアドホックタスクがキューに入れられている場合、スケジュールタスクを定期的に実行できなくなります。';
