...
/**
 * Strings for component 'local_yumymedia', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['accesscontrol_changed'] = '変更あり';
$string['accesscontrol_updated'] = 'アクセス制御の設定が更新されました。<br>マイメディアに戻ります。';
...
$string['attach_file'] = 'ファイルを新規メディアに対応付け中 ...';
$string['back_label'] = '戻る';
$string['camera_preview'] = 'カメラプレビュー';
...
$string['created_header'] = '作成日';
$string['creatorid_header'] = '作成者';
...
$string['disable_objecturl'] = 'このアップローダはcreateObjectURLとrevokeObjectURLを使用します。<br>しかし、あなたのWebブラウザはこれらの関数をサポートしていません。<br>他のWebブラウザをご利用ください。';
$string['disable_webrtc'] = 'このアップローダはWebRTCを必要とします。<br>しかし、あなたのWebブラウザはWebRTCをサポートしていません。<br>他のWebブラウザをご利用ください。';
$string['download_link'] = 'ダウンロード';
$string['edit_link'] = '編集';
$string['entryid_header'] = '登録ID';
...
$string['privacy:metadata'] = 'マイメディアはいかなる個人情報も保存しません。';
$string['problem_viewing'] = 'ページの表示中に問題が発生しました。システム管理者に連絡してください。';
$string['progress'] = '進捗';
$string['recorder_uploading'] = '録画したファイルをアップロード中 ...';
$string['required_field'] = '必須項目';
$string['require_https'] = 'このアップローダはHTTPS（暗号通信）を必要とします。<br>システム管理者に連絡してください。';
...
$string['unsupported_browser'] = 'このアップローダはあなたのWebブラウザ ({$a}) には対応していません。<br>他のWebブラウザをご利用ください。';
$string['unsupported_camera'] = '非対応のWebカメラを使用しているか、Webカメラがすでに使用中です。<br>Webカメラの状態を確認してください。';
$string['unsupported_filetype'] = 'サポートされていない種類のファイルです。';
$string['unsupported_os'] = 'このアップローダはあなたのOS ({$a}) には対応していません。<br>あなたの端末向では通常のアップローダをご利用ください。';
$string['uploader_hdr'] = 'メディア・アップローダー';
$string['uploader_uploading'] = '選択したファイルをアップロード中 ...';
$string['upload_form_hdr'] = 'メディア・アップロード・フォーム';
$string['uploading_header'] = 'アップロード中';
$string['upload_label'] = 'アップロード';
$string['upload_success'] = 'アップロードに成功しました。';
$string['upload_success_hdr'] = 'アップロードの成功';
$string['video_preview'] = '録画済み動画プレビュー';
...
$string['wrong_desc'] = '説明の中に使用できない文字があります。';
$string['wrong_filesize'] = 'ファイルサイズが不正です。';
$string['wrong_letter'] = '{$a}の中に使用できない文字があります。';
$string['wrong_metadata'] = 'メタデータの内容が不正です。';
$string['wrong_name'] = '名前の中に使用できない文字があります。';
$string['wrong_tags'] = 'タグの中に使用できない文字があります。';
