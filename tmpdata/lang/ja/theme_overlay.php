...
/**
 * Strings for component 'theme_overlay', language 'ja', branch 'MOODLE_31_STABLE'
 *
...
$string['configtitle'] = 'Overlay設定';
$string['customcss'] = 'カスタムCSS';
$string['customcssdesc'] = 'このテーマのカスタマイズを容易にするよう、あなたがここで入力したCSSはすべてのページに追加されます。';
$string['footertext'] = 'フッタテキスト';
$string['footertextdesc'] = 'フッタノートまたはフッタテキストを設定します。';
$string['headercolor'] = 'ヘッダ色';
$string['headercolordesc'] = 'ヘッダの背景色です。';
