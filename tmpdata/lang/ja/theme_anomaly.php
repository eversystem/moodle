...
/**
 * Strings for component 'theme_anomaly', language 'ja', branch 'MOODLE_31_STABLE'
 *
...
$string['taglinedesc'] = 'このタグラインテキストボックスに入力したテキストは、あなたのMoodleサイトのみのフロントページヘッディングの下に表示されます。';
