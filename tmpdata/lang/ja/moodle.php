...
$string['defaulthomepageuser_help'] = 'あなたのホームページがナビゲーションの最初のリンクになります。';
$string['delete'] = '削除';
...
$string['dndnotsupported_help'] = 'あなたのブラウザはドラッグ＆ドロップアップロードをサポートしていません。この機能はすべての最近のバージョンのChrome、Firefox、SafariおよびInternet Explorer v10以上で利用できます。';
