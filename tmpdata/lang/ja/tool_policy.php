...
/**
 * Strings for component 'tool_policy', language 'ja', branch 'MOODLE_38_STABLE'
 *
 * @package   tool_policy
...
$string['errorsaveasdraft'] = 'マイナーチェンジは下書きとして保存できません。';
...
$string['listactivepolicies'] = 'アクティブポリシー一覧';
...
$string['nopermissiontoagreedocscontact'] = 'さらなる支援が必要な場合、次にご連絡ください:';
