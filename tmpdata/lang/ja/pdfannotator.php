...
/**
 * Strings for component 'pdfannotator', language 'ja', branch 'MOODLE_37_STABLE'
 *
...
$string['choice_viewanswers'] = '回答を表示する';
$string['choice_viewreports'] = 'レポートを表示する';
$string['chooseyoursettings'] = 'このモジュールの新しい活動に関して通知を希望しますか?';
$string['clicktoopen2'] = 'ファイルを表示するには {$a} リンクをクリックしてください。';
$string['closeAll'] = 'すべてを折りたたむ';
$string['closedquestions'] = '解決済み';
$string['colorPicker'] = '色を選択する';
$string['comment'] = 'コメント';
$string['commentDeleted'] = 'コメントが削除されました。';
$string['comments'] = 'コメント';
$string['continueDiscussion'] = 'コメントを追加する';
$string['correct'] = '正しい';
$string['count'] = 'カウント';
...
$string['displayagain'] = '再度表示する';
$string['displayreportagain'] = 'レポートを表示する';
...
$string['error:hide'] = 'エレメントの非表示中にエラーが発生しました。';
...
$string['error:putinrecyclebin'] = 'アイテムをゴミ箱に入れることができませんでした。';
...
$string['error:settimespan'] = '新しい質問の期間設定中にエラーが発生しました。';
$string['error:show'] = 'エレメントの表示中にエラーが発生しました。';
...
$string['gotocomment'] = 'コメントを開きます。';
$string['gotoquestion'] = '質問を開きます。';
$string['guestscantdoanything'] = 'ゲストはここで何もできません。';
$string['hiddenComment'] = '非表示コメント';
$string['hiddenforparticipants'] = '学生から隠す';
$string['hiddenreportstitle'] = 'ごみ箱  (レポート)';
$string['hiddenreportstitle_help'] = 'あなたは非表示コメントを再度表示するか、完全に削除できます。';
$string['hideAnnotations'] = 'アノテーションを隠す';
$string['hideanswerforever'] = '完全に隠す';
$string['hideforever'] = '完全に隠す';
$string['highlight'] = 'テキストをハイライトしてコメントを追加します。';
$string['hour'] = '時間';
$string['hours'] = '時間';
$string['inaccurate'] = '不正確';
$string['inappropriate'] = '不適切';
$string['in_course'] = 'このコース';
$string['in_document'] = 'このドキュメント';
$string['infonocomments'] = '現在、このドキュメントにコメントはありません。';
$string['interestedpeople'] = '質問を興味深いと考える他の人';
$string['introquestions'] = 'このコースの未解決の質問すべてが表示されます。';
...
$string['justnow'] = '現在';
$string['labelforsettingnewsspan'] = '期間を選択する';
...
$string['mypost'] = '私の投稿';
$string['mypoststitle'] = '私の投稿';
$string['mypoststitle_help'] = 'このコース内のあなたの匿名投稿を含むすべての投稿の一覧です。削除済み投稿は除きます。';
...
$string['newanswersavailable'] = '最近の回答';
$string['newanswersavailable_help'] = 'あなたがこのコースで質問または購読した質問に対する回答すべてを表示します。';
$string['newanswersavailable_helptitle'] = '最近の回答のヘルプ';
...
$string['nohiddenanswernotifications'] = '現在、このコースに非表示回答はありません。';
$string['nohiddenreports'] = '現在、このコースに非表示報告はありません。';
...
$string['onlyDeleteOwnComments'] = 'あなたは他のユーザのコメントの削除を許可されていません。';
$string['onlyDeleteUncommentedPosts'] = '他のユーザのコメントも同時に削除されます。';
$string['openAll'] = 'すべてを表示する';
$string['openquestions'] = '未解決';
$string['other_reason'] = '他の理由';
$string['overview'] = '概要';
$string['overviewactioncolumn'] = '管理';
$string['OverviewConfigCouldNotBeSaved'] = 'あなたのブラウザがこの機能をサポートしていないため、現在の表示を保存できませんでした。';
$string['OverviewConfigSaved'] = '現在の表示が保存されました。';
$string['own'] = '自分の';
...
$string['pleaseSelectReportReason'] = '--- このコメントを報告するあなたの理由を記述してください。 ---';
...
$string['printwhat'] = '何をオープンしますか?';
$string['printwhatTitle'] = 'PDFをAcrobat Readerで開く';
...
$string['privacy:metadata:pdfannotator_commentsarchive'] = '報告後に削除されたコメントはここにアーカイブされます。保存される情報は他のコメントと同じです。';
...
$string['public'] = 'パブリック';
$string['putinrecyclebin'] = '既読にする';
$string['putinrecyclebin_report'] = '既読にする';
$string['question'] = '質問';
$string['questions'] = '質問';
...
$string['recyclebin_overview_managerintro'] = 'このページではこのコースのすべての非表示報告通知を表示します。';
$string['recyclebin_overview_studentsintro'] = 'このページではこのコースであなたが質問または購読した質問の非表示回答通知すべてを表示します。';
$string['recyclebintab'] = '読む';
$string['recyclebintabicon'] = '読む';
$string['recyclebintabicon_help'] = 'このページではこのコースで「既読」とマークされた報告すべてが表示されます。';
$string['register'] = '適用';
...
$string['reportForbidden'] = '報告不許可';
$string['reportinfotitle'] = '報告済みコメント';
$string['reportinfotitle_help'] = 'このコースの報告すべてが一覧表示されます。';
$string['reportreason'] = 'このコメントを報告する理由';
...
$string['saveOverviewConfig'] = 'この表示を記憶する';
$string['search'] = '検索';
...
$string['setting_choosetimespanfornews'] = 'どのくらいの期間、コメントを新しいとマークしますか?';
$string['setting_col_annotating_enabled'] = 'PDFの共同アノテーションを有効にする';
...
$string['successfullyPutInRecycleBin'] = 'アイテムがゴミ箱に入れられました。';
$string['successfullyRedisplayed'] = 'コメントが参加者に再度表示されます。';
$string['successfullyRedisplayedAnswer'] = 'アイテムが「回答」カテゴリに再度移動されました。';
$string['successfullyRedisplayedReport'] = 'アイテムが「報告」カテゴリに再度移動されました。';
...
$string['timecouldnotbeset'] = 'エラーが発生しました。';
$string['timewasset'] = 'あなたの選択が保存されました。';
$string['titleforreportcommentform'] = 'コメントを報告する';
$string['tooverview'] = '→ 概要';
$string['toreport'] = 'レポート';
$string['tosettingspage'] = '設定ページに移動する';
$string['total'] = '合計';
...
$string['view'] = 'ドキュメント';
$string['viewAllActivitiesInThisCourse'] = 'このコースの新しい活動のモジュールすべてを表示しますか?';
$string['votes'] = 'いいね';
