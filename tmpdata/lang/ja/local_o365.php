...
/**
 * Strings for component 'local_o365', language 'ja', branch 'MOODLE_38_STABLE'
 *
 * @package   local_o365
...
$string['acp_title'] = 'Office365管理コントロールパネル';
...
$string['spsite_group_contributors_name'] = 'コントリビュータ {$a}';
