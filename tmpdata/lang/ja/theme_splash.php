...
/**
 * Strings for component 'theme_splash', language 'ja', branch 'MOODLE_30_STABLE'
 *
...
$string['tagline'] = 'タグライン';
$string['taglinedesc'] = 'このテキストエリアのコンテンツはホームページのサイトロゴの下に表示されます。';
