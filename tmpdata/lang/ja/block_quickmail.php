...
/**
 * Strings for component 'block_quickmail', language 'ja', branch 'MOODLE_35_STABLE'
 *
...
$string['addionalemail'] = '外部メールアドレス宛のメール送信を許可する';
$string['addionalemail_desc'] = 'このオプションを有効にした場合、クイックメールはユーザがフォームに入力した外部メールアドレス宛にもメールを送信します。';
...
$string['allowstudents'] = '学生にクイックメール使用を許可する';
...
$string['download_auth_only'] = '認証済みユーザのみ';
$string['download_open'] = 'ダウンロードを開く';
