...
/**
 * Strings for component 'repository_onedrive', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['skydrivefilesexist'] = 'Microsoft SkyDriveリポジトリにファイルが見つかりました。このリポジトリはMicrosoftによって廃止されましたが、ファイルはこのMicrosoft OneDriveリポジトリに自動的にインポートすることができます。';
